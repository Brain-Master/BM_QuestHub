...
describe("resolvePublicMediaUrl", () => {
  ...
  it("maps legacy /venues/ paths to S3 media/venues/", () => {
    ...
    assert.equal(
      ...
      "https://storage.yandexcloud.net/bm-questhub/media/venues/logos/school-1517.webp",
    );
    assert.equal(
      resolvePublicMediaUrl("/venues/photos/school-1212-yasenevo/01.webp"),
      "https://storage.yandexcloud.net/bm-questhub/media/venues/photos/school-1212-yasenevo/01.webp",
    );
  });
  ...
  it("maps legacy schedule paths with colons to __ storage keys", () => {
    ...
    assert.equal(
      ...
      "https://storage.yandexcloud.net/bm-questhub/media/schedule/cyber-rhythm__school-17__2026-06-22__2026-06-26/hero.webp",
    );
  });
