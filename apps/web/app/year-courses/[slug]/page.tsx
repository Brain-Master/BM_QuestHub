...
export default async function ProgrammePage({params}:Props) {
  ...
  return <main className="yc-page">
    ...
    {program.id === "shmi" && <YearScheduleLink programme="shmi" />}
