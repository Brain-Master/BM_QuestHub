...
export function QuestHeroBanner({ quest, world }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col gap-5 border-white/10 border-t bg-black/35 px-6 py-6 backdrop-blur-md md:flex-row md:items-start md:justify-between md:px-8 md:py-7">
        <div className="flex gap-4 md:gap-5">
          <div className="flex size-14 shrink-0 items-center justify-center rounded-2xl border border-white/20 bg-black/25 text-white shadow-inner md:size-16">
          ...
          <div className="min-w-0 space-y-2">
            ...
            <h1 className="font-heading text-balance text-2xl font-semibold tracking-tight text-white md:text-4xl">
              {quest.title}
            </h1>
