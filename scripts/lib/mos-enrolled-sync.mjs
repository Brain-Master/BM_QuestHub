...
import { loadSyncState, onSyncFinished } from "./mos-sync-state.mjs";
 ...
 * @param {string} range
 */
async function fetchFormatsGrid(token, spreadsheetId, range) {
 ...
 */
async function batchWriteCells(token, spreadsheetId, updates) {
